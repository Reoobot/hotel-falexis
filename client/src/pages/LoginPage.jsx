...
export default function LoginPage() {
    ...
    async function handleLoginSubmit(ev, credentials) {
      ...
      try {
        const response = await axios.get('https://booking-sand-two.vercel.app/api/user', credentials);
    
        if (response.status === 200) {
          const userDataResponse = await axios.get('https://booking-sand-two.vercel.app/api/user', {
            headers: {
